...
- **[Trigger: After Code Change] Provenance Logging:** 룰북 변경 후 `contexts/dotfiles/scripts/log-edit.sh`를 실행하여 수동 근거 기록.
- **[Trigger: 연속 실패 | Fast Fail & Halt | 사용자 지적] Quality Flywheel:** 계속 실패 시 `contexts/dotfiles/scripts/prompt-flywheel.sh`로 룰 개정안 역제안.
