...
FAILED=()
for suite in test-run-suite test-tool-probe-ssot test-script-init test-parallel-pair test-plugin-loop test-finops test-db-sg test-idempotency test-shell test-yaml; do
