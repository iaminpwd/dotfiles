<domain_specific_rules instruction="Apply these rules ONLY when working with FinOps, DORA metrics, CloudWatch, Datadog, Prometheus, or infrastructure cost optimization.">
