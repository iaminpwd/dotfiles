...
# 키워드 뒤에 ':'/'=' 대입이 바로 오는 경우만 매치한다(값 자체가 아니라 필드/변수
# 이름일 뿐인 password_policy, secret_key_rotation_enabled, variable "db_password" {}
# 같은 무해한 식별자까지 걸려 실제 커밋을 차단하는 오탐이 실측됨. 2026-08-05).
