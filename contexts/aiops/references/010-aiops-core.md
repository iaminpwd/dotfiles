...
- **[Trigger: Infra Design Completed] 도메인 자가 채점:** 아키텍처나 스크립트 설계를 완료한 직후, 스스로 제3의 평가자 페르소나로 전환하여 아래 2가지 기준으로 1~5점 자가 채점을 수행하고 사유를 명시하십시오. (두 기준 모두 5점 만점일 때만 설계를 최종 제안하십시오)
